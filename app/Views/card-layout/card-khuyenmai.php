                        ...
                        <div class="card card-1" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/home/giohang" method="POST">
                                    ...
                                    <input oninput="checkValue(this);" type="number" name="soluong" id="soluong" min="1" max="<?= $sanphams->soluong ?>" value="1" style="width:30% ;text-align:center;margin-left:5%;height:35px!important;">
