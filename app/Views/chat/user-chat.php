            ...
            <div class="row">
                ...
                <div class="col-2 m-auto mt-2 ">
                    <div class="list-group" style="width:144%">
                        ...
                        <a href="/chat/<?=$chattn->id_nguoigui?>" class="list-group-item list-group-item-action"
                            style="background-color:blue;"><?=$chattn->nguoigui->username?>
                            <?php foreach ($chat as $chat1):
                                if($chat1->id_nguoigui==$chattn->id_nguoigui || $chat1->id_nguoigui==$chattn->id_nguoinhan):
                                   
                                ?>
                                 <br>
                                 <div style="text-align:center ;" ><?=$chat1->noidung?></div>
                        ...
                        <?php else:?>
                        <a href="/chat/<?=$chattn->id_nguoigui?>" class="list-group-item list-group-item-action"
                            style=""><?=$chattn->nguoigui->username?>
                        ...
                        <?php endif;?>
                        <?php 
                        $dain[$chattn->id_nguoigui]=1;  endif;?>
                            ...
                            ?>
                                <td style="text-align:right ;">
                                    <img style="width:40px;height: 40px;"
                                        src="<?= request()->baseUrl(); ?>/assets/images/profile/<?= $profiles->avatar ?? 'avatar.png' ?>"
                    ...
                    <form enctype="multipart/form-data" action="/chat/<?=$id_nguoinhan?>" method="POST">
                        <div class="row ">
                            ...
                            <div class="col-8" style="margin-left:22% ;margin-top:2px ;">
                                ...
                                <input required type="text" name="noidung" class="form-control form-input "
